...
export const revansRaids:Record<RevansRaidId,RevansRaid>={
  ...
  seofon:{
    ...
    recommendation:"Test the owned Fire core, but keep it labelled experimental until it reaches the target consistently. Percival and Ragazzo are the verified rescue upgrades.",
    presets:[
      {title:"Modern rescue Full Auto",purpose:"Short blue-chest farming",confidence:"Later",team:["Manadiver","Ragazzo","Grand Percival","Grand Zeta","FLB Fraux","Michael"],settings:["CA OFF","Full Auto ON","Reloading improves consistency in fast rooms"],requirements:["Grand Percival and Ragazzo","Sufficient normal/skill cap","HP or recovery to continue through 10%"],operation:["Enter a healthy raid and start Full Auto.","Expect roughly three to four turns depending on grid and lobby speed.","Do not design only for the contribution line if the room may stall at 10%."]},
      {title:"Owned Fire test",purpose:"Initial self-host or slower rescue",confidence:"Account test",team:["Manadiver","Grand Zeta","Michael","Grand Wilnas","Defensive reserve","Flexible reserve"],settings:["Start with CA OFF for normal/skill damage","Switch to CA ON only for a tested survival route"],requirements:["This is not the published Percival/Ragazzo rotation","Check 4m contribution consistency","Check survival at the 10% trigger"],operation:["Test on self-hosts before relying on public rescues.","If damage is short, use the Sandira Kengo team as the slower CA experiment.","Prioritize Percival before treating Seofon as solved."]},
    ],
  ...
  agastia:{
    ...
    recommendation:"Build around Grand Cosmos and Kengo. Obtain Peejiu before investing in a normal-attack alternative.",
    presets:[
      {title:"Accessible CA Full Auto",purpose:"Blue-chest contribution",confidence:"Account test",team:["Kengo","Grand Cosmos","Peejiu","Grand Noa or Nehan","Grand Lu Woh · sustain flex","Flexible reserve"],settings:["CA ON","Nehan skill 3 OFF when used","Quick summon according to the tested charge loop"],requirements:["Light Unsigned Kaneshige","Approximately 60k HP","Peejiu","A plan for the 30-hit and 10-debuff omens"],operation:["Prefer joining near 100% while learning the sequence.","Use full chains to build Limit Over.","Do not call this zero-intervention until potion and 60% behavior are tested."]},
      {title:"Summer Horus upgrade",purpose:"Current published CA route",confidence:"Later",team:["Kengo","Grand Cosmos","Summer Horus","Nehan or Summer Seruel","Grand Sandalphon","Yukata Narmaya"],settings:["CA ON","Nehan skill 3 OFF","Some versions require potions"],requirements:["Summer Horus","Defensive awakenings","CA and skill-cap support in the grid"],operation:["Join at 100% when the rotation relies on Cosmos skill 3 for the 60% 30-hit trigger.","Verify whether the specific build is rescue FA or semi-FA."]},
    ],
  ...
  mugen:{
    ...
    presets:[
      {title:"Magna defensive Full Auto",purpose:"Self-host and rescue",confidence:"Later",team:["Paladin","Europa","SR Karva · sacrificial","FLB Anne","FLB Haaselia","Gabriel or Maria Theresa"],settings:["Full Auto ON","CA ON","Quick summon Car.On or Fire Carbuncle"],requirements:["Three Defense-awakened Schrodingers in the demonstrated build","FLB Haaselia skill 4","Roughly 60–70k HP","Barrier mainhand"],operation:["Avoid pushing the first phase so quickly that Extinction level remains high.","Use barriers after healing becomes unavailable.","Treat Grand Yatima as a Varuna alternative, not the demonstrated Magna slot."]},
      {title:"Owned Wamdus Kengo",purpose:"Mostly automatic entry test",confidence:"Account test",team:["Kengo","Grand Yatima or gauge support","Wamdus","Grand Sylvia","Haaselia","Gabriel"],settings:["CA ON","Manual mitigation calls remain necessary","Quick summon Car.On or Fire Carbuncle"],requirements:["Water Kaneshige","Wamdus CA/FC mitigation loop","High HP","Prefer initial Schrodingers"],operation:["Alternate Wamdus CA mitigation with FC mitigation.","Manually call a fire-cut summon for Giant Ban.","This is semi-FA, not a verified unattended composition."]},
    ],
  ...
  siegfried:{
    ...
    presets:[
      {title:"Modern control Full Auto",purpose:"Stable contribution",confidence:"Later",team:["Boogeyman","Cagliostro & Clarisse","Estarriola","Grand Rosetta / Grand Galleon / cover unit","Katzelia","Flexible reserve"],settings:["CA ON","Full Guard ON","Reloading recommended for competitive honors"],requirements:["Frequent automatic dispels","Cover or all-substitute for Kvalfang","Enough defense to reduce incoming damage to zero where possible"],operation:["Let the boss use CT specials instead of delaying indefinitely.","Cancel or safely receive Kvalfang to control stacks.","Dispel the alternating buffs quickly."]},
      {title:"Defensive class alternatives",purpose:"Slow entry and self-host",confidence:"Verified",team:["Black Cat / Monk / Robin Hood","Defensive dispeller","Cover unit","Sustain unit","Defensive reserve","Katzelia or flex"],settings:["CA often OFF in Black Cat examples","Full Guard ON","Quick summon Transcended Lucifer where available"],requirements:["Long clear time","Substantially lower honor speed","Exact substitutions must be tested"],operation:["Use this route to enter without Estarriola, not as evidence that the modern core is unnecessary.","Prioritize survival and dispels over a normal-burst lineup."]},
    ],
  ...
  cosmos:{
    ...
    presets:[
      {title:"Magna Lich control Full Auto",purpose:"Practical contribution",confidence:"Later",team:["Shieldsworn","Koku","Lich","Fediel","Kou","Flexible reserve"],settings:["Fediel skill 3 manually at battle start","CA depends on the exact balance version","Celeste support preferred in the cited Lich setup"],requirements:["Koku and Fediel","Large-hit counterweight to Lich's multihits","Gauge monitoring while validating"],operation:["Use Lich's end-of-turn hits to push blue intentionally.","Ensure the remaining damage can return the gauge toward red.","Do not assume Lich is universally unsafe or universally sufficient."]},
      {title:"Current 2026 premium Full Auto",purpose:"Faster blue-chest route",confidence:"Later",team:["Manadiver","Summer Magus","Vikala","Indala","Kou","Orologia"],settings:["CA ON","Indala skill 3 OFF in the rescue version"],requirements:["Summer Magus—not Summer Magisa","Vikala and Indala","Balanced large-hit and multihit output"],operation:["Expect rescue stability to depend on the raid's current toxic level and HP position.","Revalidate the 25% forced-blue phase before calling it unattended."]},
    ],
