...
const basePlans: Plan[] = [
  ...
  },
  {
    ...
    teams: [
      team(
        ...
        "FAST FA",
        "Mahira stands immediately before Narmaya so the next-position buff targets her.",
        [
          { name: "MC", role: "Manadiver" },
          { name: "Summer Mahira", role: "Position buffer", id: "3040584000" },
          { name: "Grand Narmaya", role: "Main DPS", id: "3040335000" },
          { name: "Raphael", role: "Core support", id: "3040568000" },
        ],
      ),
      team(
        "Safe CA / long FA",
        "CA ON",
        "Catura is the broad upgrade; Summer Galleon primarily improves the fast team.",
        [
          { name: "MC", role: "Kengo" },
          { name: "Grand Charlotta", role: "CA / defense", id: "3040438000" },
          { name: "Cag & Clarisse", role: "Heal / clear", id: "3040593000" },
          { name: "Raphael", role: "Core support", id: "3040568000" },
        ],
      ),
    ],
  ...
  },
  {
    ...
    teams: [
      team(
        ...
        "CA ON",
        "Cosmos replaces Lu Woh for multi-hit skill damage and dispels. Restore Lu Woh only when the fight needs more healing and sustain.",
        [
          { name: "MC", role: "Manadiver" },
          { name: "Summer Payila", role: "Main attacker", id: "3040672000" },
          { name: "Basara", role: "Damage / utility", id: "3040582000" },
          {
            name: "Grand Cosmos",
            role: "Skill / dispel utility",
            id: "3040467000",
          },
        ],
      ),
      team(
        "Cosmos CA team",
        "CA ON",
        "Summer Horus is the strongest specific future upgrade.",
        [
          { name: "MC", role: "Kengo" },
          { name: "Grand Cosmos", role: "CA DPS", id: "3040467000" },
          { name: "Grand Noa", role: "Charge support", id: "3040255000" },
          { name: "Grand Lu Woh", role: "Sustain", id: "3040449000" },
        ],
      ),
    ],
    grids: [
    ...
    priorities: [
      ...
      "Grand Sandalphon later",
    ],
    backline: ["Yukata Zahlhamelina", "Yukata Narmaya", "Geisenborger later"],
    opus: [
      {
        team: "TEAM A · PRIMARY GENERAL FA",
        cap: "Beta · Skill DMG Cap",
        ...
        note: "Payila and Basara keep the team normal-led, so Extremity remains the evidence-based direction and Beta leaves Normal Cap to Ultima. Cosmos makes Skill Cap more valuable through repeated multi-hit damage and dispels; keep CA on so her CA/skill cycle functions.",
      },
    ],
    mastery: [
      {
    ...
    awakenings: [
      ...
      },
      {
        name: "Grand Cosmos",
        type: "Defense",
        note: "Current JP first choice for the long and high-difficulty content where Cosmos is normally used. It also compensates for replacing Lu Woh's sustain slot. Keep Balance only when the battle log shows she already survives reliably and the awakening jewel is better saved.",
      },
      {
        name: "Summer Heles",
        type: "Balance",
    ...
    overMastery: [
      ...
      },
      {
        ...
        ring4: "DEF 10–20%",
        earring: "Supplemental DMG 5–12",
        note: "Current JP guides explicitly converge on Skill DMG Cap and Supplemental Damage for her repeated multi-hit skills. DEF is the account-specific fourth-slot target because she is replacing Lu Woh; it helps her stay near the 50% HP balance point without pretending she provides his healing.",
      },
      {
        name: "Summer Heles",
        ring3: "Stamina 5–10",
  ...
  },
  {
    ...
    subtitle: "Magna",
    color: "#7456a3",
    current: "Skill FA + Seox progression",
    teams: [
      team(
        "Azusa / Lich skill axis",
        "SKILL BURST / FA",
        "Use Lich, Magisa and Tsukuyomi for sustained Full Auto; replace Tsukuyomi with Summer Azusa for offensive or one-turn skill damage.",
        [
          { name: "MC", role: "Manadiver" },
          {
            name: "Grand Lich",
            role: "Sustained skill core",
            id: "3040357000",
          },
          {
            name: "Summer Magisa",
            role: "Crest / skill damage",
            id: "3040412000",
          },
          { name: "Tsukuyomi", role: "Sustain · Azusa flex", id: "3040581000" },
        ],
      ),
      team(
        "Seox general team",
        "GENERAL FA",
        "Summer Magisa replaces Tsukuyomi when survival is solved; Grand Sariel is the future offensive upgrade.",
        [
          { name: "MC", role: "Manadiver" },
          { name: "Seox", role: "Main DPS", id: "3040035000" },
    ...
    grids: [
      ...
      {
        name: "Seox general Magna III",
        tag: "TARGET",
        note: "Balanced general Full Auto shell. Keep three Ater fists but reduce to one Ater saber so Seox retains room for HP, normal damage and specialty support. This does not require Kaneshige or a five-fist one-sided setup.",
        weapons: [
          ["MH", "Exo Hamartia", "Attack awakening"],
          ["×3", "Celeste Grace Ater", "Boost + cap"],
          ["×1", "Celeste Saber Ater", "Hybrid skill slot"],
          ["×1", "Zechariah", "Stamina + HP"],
          ["×1", "Abyss Spine", "CA + HP"],
          ["×1", "Katana of Renunciation", "Omega Opus"],
          ["×1", "Covenant-Ruin Fist", "Seox specialty"],
          ["×1", "Scythe of Darkherald", "23% seraphic"],
        ],
      },
    ],
    priorities: [
      ...
      "Recruit and develop Seox",
      "Raise Celeste toward 250",
      "Grand Sariel",
    ],
    backline: [
      "Best owned reinforcement now",
      "Nier + The Death",
      "Sariel when not frontline",
    ],
    opus: [
      {
        team: "TEAM A · SKILL BURST / FA",
        cap: "Beta · Skill DMG Cap",
        pendulum: "Strength for sustained FA",
        transcend: "Sagacity when skill damage leads",
        note: "Azusa, Lich and Magisa all reward Skill Cap. Keep Strength for unattended consistency; Sagacity is the natural transcendence direction when the battle log confirms skills are the leading damage source.",
      },
      {
        team: "TEAM B · SEOX GENERAL FA",
        cap: "Beta · Skill DMG Cap",
        pendulum: "Strength for general FA · Falsehood for tested short routes",
        transcend: "Extremity for normal-led damage",
        note: "Seox shifts the team toward normal damage while Lich still supplies frequent automatic skills. Beta leaves Normal Cap to Ultima; do not force Falsehood in unattended content that needs ordinary charge attacks or sustain.",
      },
    ],
    mastery: [
      {
