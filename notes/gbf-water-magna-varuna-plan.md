...
Owned core includes Payila, Grand Gabriel, Grand Octavia, Grand Yatima, Grand Sylvia, Wamdus, Grand Poseidon, Summer Lucio and Cupitan. Varuna is not yet owned; a base Gabriel summon is owned.
...
- Grand Gabriel
- Grand Octavia
- CA On generally; Off only for tested short farming

Grand Yatima replaces Octavia when Octavia's HP/TA requirements are not met. Grand Poseidon and Summer Lucio are encounter-specific alternatives.
...
- Transitional spear mainhand for Apsaras or eventually Lancer Origin.
- A mainhand copy still counts as one of the two grid copies.
- Supplemental damage applies only when the attack crits.

### Water Dark Opus staff

- Long-term recommendation with Manadiver.
- Chain of Falsehood enables party Double Strike and complements Payila.
- Use a safer Stamina/skill setup for difficult unattended battles when Falsehood's tradeoff is undesirable.

## Modern Magna III destination

| Quantity | Weapon |
|---:|---|
| 1 | Staff of Renunciation, normally mainhand |
| 2 | Leviathan Gaze Mare |
| 2 | Leviathan Cranium Mare |
| 2 | Wamdus's Cnidocyte |
| 1 | Leviathan Spear Omega or another crit-adjustment weapon |
| 1 | Celestial Staff |
| 1 | Gabriel Wand, later replaced when Ultima carries the Seraphic key |
...
| Slot | Weapon |
|---|---|
| Mainhand | Staff of Repudiation, or Magna Staff of Renunciation with Falsehood |
| 2–3 | Rubea Stiria ×2 |
| 4 | Taisai Spirit Bow |
| 5 | Galilei's Insight |
| 6 | Gospel of Water and Sky |
| 7 | Wamdus's Cnidocyte |
| 8 | Knight of Ice or defensive flex |
| 9 | Ultima Staff |
...
The specialized ceiling is a Hraesvelgr normal-attack grid:

- Hraesvelgr mainhand
- Rubea Stiria ×2
- Bridekeeper ×2
- Clockwork Blade: Kumogakure ×2
- Taisai Spirit Bow or Galilei's Insight
- Transcended Staff of Repudiation
- Destroyer weapon
- Ultima/Celestial pieces in extra slots

It requires Soldier, bullets, premium characters, summon support and enough TA to overcome Hraesvelgr's penalty. It is not the recommended casual Full Auto route. Clockwork Blade's Deathstrike echo can also overlap poorly with Falsehood or Haaselia, so two Octavia weapons are not automatically optimal for Manadiver.
...
- [GameWith Water Magna progression](https://xn--bck3aza1a2if6kra4ee0hf.gamewith.jp/article/show/47186)
- [Kamigame Varuna guide](https://kamigame.jp/%E3%82%B0%E3%83%A9%E3%83%96%E3%83%AB/%E6%AD%A6%E5%99%A8%E7%B7%A8%E6%88%90/%E7%90%86%E6%83%B3%E7%B7%A8%E6%88%90_%E6%B0%B4%E7%A5%9E.html)
