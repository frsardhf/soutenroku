...
- **Grand Kaguya:** defensive/high-difficulty support and sustain. Stronger in long or demanding content than in simple speed farming.
- **Grand Grimnir 5-star:** older but still usable offensive/defensive support with veil, dispel cancel, assassin and cap support.
- **Spinnah SSR:** selfish short normal attacker with guaranteed TA, double strike, echo, supplemental damage and a flurry turn.
...
Use **Tiamat Omega 250 × Tiamat Omega 250** as the default stable Full Auto setup.

General Magna III direction:

- 2–3 Tiamat Aura Magna offensive/Exalto weapons
- 1–2 additional Aura weapons chosen for HP, cap or supplemental requirements
- Magna Dark Opus, eventually 5-star or 6-star
- Ultima weapon matching the active team's specialties when appropriate
- Celestial weapon appropriate to the dominant frontline specialty
- Ewiyar's Beak for skill-damage teams when its supplemental effect is useful
- Grimnir Harp or another farmed Magna piece as a transition/flex slot
- Draconic weapon for encounters requiring substantially more durability

Do not Damascus-bar the Magna grid. Exact counts should wait for the Wind weapon payload because Narmaya normal burst and Cagliostro & Clarisse skill/CA Full Auto value different cap and supplemental pieces.
...
Do not spark another general support character merely because it has a higher aggregate rating. The account's largest immediate improvements come from leveling the owned modern core and completing Magna III.

Do not chase Summer Galleon when she is merely an extremely low off-rate result and not sparkable. Do not use a Siero ticket on Catura or Summer Galleon while a realistic future spark route remains available.
